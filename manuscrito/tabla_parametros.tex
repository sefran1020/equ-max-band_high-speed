...
\multirow{5}{*}{Physical lines (RLGC)}
 ...
 & Lengths (\textit{equal\_il} criterion) & FR-4 $22.9''$, Megtron~6 $36.9''$ (match RC IL at Nyquist) \\
 & Length (\textit{fixed} criterion); reference IL & $10''$ both; IL${=}7.38\,\mathrm{dB}$ at $2\,\mathrm{GHz}$ \\
\hline
...
\multirow{3}{*}{Equalization}
 & FFE (3 taps) $[c_{pre},c_{main},c_{post}]$; normalization & $[0,\,1,\,-0.301]$; amplitude $\sum_i|c_i|=1$ \\
