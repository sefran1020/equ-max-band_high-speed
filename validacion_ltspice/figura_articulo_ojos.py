...
DEST = os.path.normpath(os.path.join(
    AQUI, "..", "..", "IEEE-conference-template-062824Nvo",
    "fig_ltspice_ojos.png"))
SPU = 100
...
def main():
    ...
    ojo(ax[0], vu_py, "#2b6cb0", "(a) Cadena en frecuencia (Python)")
    ojo(ax[1], vu_lt, "#c05621", "(b) Simulador de circuitos (LTspice)")
    ojo(ax[2], vu_py, "#2b6cb0", "(c) Superpuestos")
    ojo(ax[2], vu_lt, "#c05621", "(c) Superpuestos")
